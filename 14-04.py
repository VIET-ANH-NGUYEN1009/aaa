...
def GUI():
    ...
    e = Text(frame_approval_list, width = 65, height = 20)
    ...
    hist = Text(frame_history_list, width = 40, height = 20)
    ...
    e1 = Text(frame_GUI_status, height = 3, width = 28, font = "Arial 13 bold", fg = "#50c78f")
    e1.pack()

    """ -----------------component in Frame status door--------------------"""
    e2 = Text(frame_door_waiting, height = 3, width = 45, font = ("Arial Italic", 12))
    e2.pack()
